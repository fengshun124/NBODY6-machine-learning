...
from module.nbody6pp.collector import SIM_ATTR_EXTRACT_CONFIG_DICT, NBody6PPH5SnapshotCollector
...
class NBody6PPSnapshotSamplerBase(ABC):
    ...
    @property
    def collector(self) -> NBody6PPH5SnapshotCollector:
        return self._collector

    @collector.setter
    def collector(self, collector: NBody6PPH5SnapshotCollector):
        if not isinstance(collector, NBody6PPH5SnapshotCollector):
